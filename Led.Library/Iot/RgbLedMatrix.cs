...
namespace Led.Library.Iot
{
    ...
    public class RgbLedMatrix
    {
        ...
        public RgbLedMatrix(PinMapping mapping, int width, int height, int chainRows = 1, int chainColumns = 1, int renderDelay = 0)
        {
        ...
        private void Render()
        {
            ...
            while (_isRendering == 1)
            {
                ...
                if(row == 0 && RenderDelay > 0) Thread.Sleep(RenderDelay);
            }
